...
session_start();
   if(!isset($_SESSION["Llpname"])&&!isset($_SESSION["email"])){
	   header('Refresh: 0; URL = http://localhost/t/company_login.php');
   }
...
$result3 = mysqli_query($connection,"SELECT Logo,Sign FROM company_registration WHERE Email= '".$Email."'");
						...
						<li class="active"><a href="">View Submitted Documents</a></li>
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a href="internship_request.php">Internship Requests</a></li>
											<li><a href="placement_request.php">Placement Requests</a></li>
										</ul>
									</li> 						
						<li class=""><a href="change_password_company.php">Change Password</a></li>
...
<pre>							<button class="btn btn-large modal_logo" type="submit" actualpath="<?php echo $Logo; ?>">Logo  <i class="icon-camera"></i></button>			   			     <button class="btn btn-large modal_sign" type="submit" actualpath="<?php echo $Sign; ?>">Signature   <i class="icon-pencil"></i></button></pre>
</div>
