...
<div class="span4" style="padding-left:500px; padding-top:100px">	
				...
				<form class="form-horizontal" action="Login/student_login_process.php" method="post" enctype="multipart/form-data">
				<fieldset>
