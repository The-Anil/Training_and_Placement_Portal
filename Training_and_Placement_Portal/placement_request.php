...
$result = mysqli_query($connection,"SELECT DISTINCT Serial_No FROM placement_applicant");
...
<section id="bannerSection" style="background:url(themes/images/banner/portfolio.png) no-repeat center center #000;">
	<div class="container" >	
		<h1 id="pageTitle">Placement Requests
		</h1>
	</div>
</section> 
    ...
    <tbody>
	  <?php 
		while($row1 = mysqli_fetch_array($result1)) 
			...
			echo "<td><a href=\"sophisticated_features/email_placement_applicant.php?Email=".$row1['Email']."\"><h5><i class=\"icon-ok\" ></i></h5></a></td>";
			echo "<td><a href=\"sophisticated_features/email_placement_request_remove.php?Email=".$row1['Email']."\"><h5><i class=\"icon-remove-circle\" ></i></h5></a></td>";
			echo "</tr>";
			echo "</t body>";
			}
			echo "</table>";
