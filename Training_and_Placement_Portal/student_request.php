...
$result = mysqli_query($connection,"SELECT Student_Name,Serial_No,Email,Photo,Cv FROM student_registration");
			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav pull-right">
						<li class=""><a href="admin_page.php">Back</a></li>									
    ...
    <tbody>
	  <?php 
		while($row = mysqli_fetch_array($result)) 
			...
			echo "<td><img class='modal_cv' actualpath=\"".$b."\"  src=\"cv.png\" alt=\"Curriculam Vitae\" width=\"30\" height=\"10\"></td>";
			echo "<td><img class='modal_photo' actualpath=\"".$c."\"  src=\"photo.png\" alt=\"Photo\" width=\"30\" height=\"10\"></td>";
			echo "<td><a href=\"sophisticated_features/mail_verify.php?Serial_No=".$row['Serial_No']."\"><h5><i class=\"icon-ok\" ></i></h5></a></td>";
			echo "<td><a href=\"sophisticated_features/mail_remove.php?Serial_No=".$row['Serial_No']."\"><h5><i class=\"icon-remove-circle\" ></i></h5></a></td>";
			echo "</tr>";
			echo "</t body>";
			}
			echo "</table>";
...
$('.modal_photo').click(function(){
    modal.style.display = "block";
    modalImg.src = $(this).attr('actualpath');
    captionText.innerHTML = $(this).attr('actualpath');
});
