    ...
    <tbody>
	  <?php 
		while($row = mysqli_fetch_array($result)) 
			...
			echo "<td><a href=\"sophisticated_features/placement_applicant.php?Llpname=".$row['Llpname']."\"><img src=\"apply_now.png\" alt=\"Logo\" width=\"40\" height=\"20\"></a></td>";
			echo "</tr>";
			echo "</t body>";
			}
			echo "</table>";
