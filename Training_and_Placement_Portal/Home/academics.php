...
<p>The Institute offers challenging academic programmes, at undergraduate and postgraduate levels, which
 ...
 B.Tech. Programme: The B.Tech. programme aims to provide core concepts and skills in the broad areas of 
 engineering, sciences, mathematics and humanities, supported by practicums. The practicums are intended to
 give students a first-hand understanding of leveraging their initial breadth (and skills) in programme and
 applying it to develop solutions for real-life problems. Students also learn next level concepts and do
 course projects by enrolling in advanced courses for two years, and to pursue a chosen specialization, or
 to broaden knowledge and in their programme of study. A unique feature of IIIT-Kottayam's B.Tech. programme 
 is the strong encouragement and abundance of opportunities it provides students to do research. As a result 
 a large number undergraduate students have published in prestigious journals, and top national and 
 international conferences. B.Tech. is offered in the following areas:
 
 B.Tech. in Computer Science and Engineering (CSE)
 
 B.Tech. in Electronics and Communication Engineering (ECE) <</p>
