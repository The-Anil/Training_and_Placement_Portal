...
$result = mysqli_query($connection,"SELECT Cname,Llpname,Email,Tnumber,Logo FROM company_registration");
    ...
    <tbody>
	  <?php 
		while($row = mysqli_fetch_array($result)) 
			...
			echo "<td>" . $row['Llpname'] . "</td>";
			echo "<td>" . $row['Email'] . "</td>";
			echo "<td>" . $row['Tnumber'] . "</td>";
			echo "<td><img class='modal_logo' actualpath=\"".$c."\"  src=\"logo.png\" alt=\"Company Logo\" width=\"30\" height=\"10\"></td>";
			echo "<td><a href=\"sophisticated_features/mail_verify_company.php?Llpname=".$row['Llpname']."\"><h5><i class=\"icon-ok\" ></i></h5></a></td>";
			echo "<td><a href=\"sophisticated_features/mail_remove_company.php?Llpname=".$row['Llpname']."\"><h5><i class=\"icon-remove-circle\" ></i></h5></a></td>";
			echo "</tr>";
			echo "</t body>";
			}
			echo "</table>";
