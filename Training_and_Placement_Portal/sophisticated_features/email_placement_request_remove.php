...
$mail->Subject = 'Request for placement interview rejected !';
$mail->Body = '<h1>Dear '.$student.'!</h1><br><br>
				<h3>Sorry !</h3><br>
				Your request for placement interview has been rejected by the company.<br><br>
...
$mail->AltBody = 'Some error in sending message, send another request';
	...
	if($mail->send()) {
			mysqli_query($connection,"DELETE FROM placement_applicant WHERE Llpname='".$Llpname."'");
...
echo '<meta http-equiv="refresh" content="0; URL= ../placement_request.php">';
?>