			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav pull-right">
						<li class=""><a href="student_page.php">View Submitted Documents</a></li>
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="for_internship.php">For Placement</a></li>
										</ul>
									</li> 
...
<div class="span4" style="padding-left:500px; padding-top:100px">	
				...
				<form class="form-horizontal" action="Login/change_pass_student.php" method="post" enctype="multipart/form-data">
				<fieldset>
